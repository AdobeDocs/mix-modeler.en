...
* [!UICONTROL Touchpoint effectiveness] table, representing the outcome of the Attribution AI algorithmic model. The data for this table is only generated for specific periods of time. Select **[!UICONTROL As of *xx/xx/xx, xx:xx TZ*]**  ![Info](../assets/icons/InfoOutline.svg) for more details.  
  ...
  * [!UICONTROL Paths touched]: visualizes the percentage of paths achieving conversion and percentage of paths not achieving conversion. For a touchpoint, you see more attributed conversions when the ratio is high. This ratio compares the percentage of paths that lead to conversion versus those that do not.
